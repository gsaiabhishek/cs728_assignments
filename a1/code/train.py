...
class Trainer:
	...
	def evaluate(self, dataloader_type, sigmoid_threshold = 0.5, test_index = 0):
		...
		return total_loss, correctly_classified, total_data, correctly_classified/total_data, words_and_scores
	...
	def train(self):
		...
		for epoch in range(self.cfg.train_args.num_epochs):
			...
			for _, (data, inputs, targets) in enumerate(self.trn_dataloader):
